    ...
    <div id="contenedor">
        ...
        <div id="area_busqueda">
            <form action="buscar_usuario.php" method="get" id="busca_usuario">
                <input type="text" name="busqueda" id="barra_busqueda" placeholder="Busca un usuario" value="<?php echo $busqueda; ?>">
        ...
        <script>
            ...
            async function edit_user(email) {
                let consulta = await fetch("https://zpasgon.upv.edu.es/src/api/user.php/get?email=" + email);
