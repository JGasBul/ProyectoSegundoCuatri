...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if (empty($username_err) && empty($password_err)) {
        ...
        curl_setopt($curl, CURLOPT_URL, "http://localhost/user.php/login");
    ...
    <div class="mobile-first">
        ...
        <section class="volver">
            <a href="../index.php" style="text-decoration: none">
                <img src="../assets/volver.svg" alt="volver">
                <label style="color: #ffffff">Volver</label>
            </a>
        </section>
        <!--Fin Atrás-->
            ...
            <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="post">
                ...
                <div class="contenido-email">
                    ...
                    <div class="contenido-email-interior">
                        ...
                        <input id="email-mobile" name="username" placeholder="Ponga su email" type="email" required>
                    </div>
                </div>
                <!--Fin Email-->
                <!--Inicio Contraseña-->
